...
> [docs/MCP.md](https://github.com/97kuek/flow5ctl/blob/main/docs/MCP.md) for the one-line install. flow5ctl computes the geometry,
...
> Phases 1–3 of the [roadmap](https://github.com/97kuek/flow5ctl/blob/main/docs/ROADMAP.md) are done.
>
...
> than assumed to work. The [verification log](https://github.com/97kuek/flow5ctl/blob/main/docs/log/2026-09-03-poc-verification.md)
> records what was found on the way, including a reproducible flow5 crash and seven
> ways its output misleads a naive reader; re-run any of it from [`poc/`](https://github.com/97kuek/flow5ctl/tree/main/poc).

日本語版 README: [README.ja.md](https://github.com/97kuek/flow5ctl/blob/main/README.ja.md) ／ はじめかた: [docs/ja/QUICKSTART.md](https://github.com/97kuek/flow5ctl/blob/main/docs/ja/QUICKSTART.md)
...
[docs/MCP.md](https://github.com/97kuek/flow5ctl/blob/main/docs/MCP.md).
...
Run on [`examples/hpa.yaml`](https://github.com/97kuek/flow5ctl/blob/main/examples/hpa.yaml), so you can reproduce it:
...
[docs/ARCHITECTURE.md](https://github.com/97kuek/flow5ctl/blob/main/docs/ARCHITECTURE.md).

![Architecture](https://raw.githubusercontent.com/97kuek/flow5ctl/main/docs/architecture.png)

Drawn from the import graph, not from these notes — the editable source is
[docs/architecture.drawio](https://github.com/97kuek/flow5ctl/blob/main/docs/architecture.drawio), regenerated by
[tools/gen_architecture.py](https://github.com/97kuek/flow5ctl/blob/main/tools/gen_architecture.py). A Japanese walkthrough of the
same picture is in [docs/ARCHITECTURE-ja.md](https://github.com/97kuek/flow5ctl/blob/main/docs/ARCHITECTURE-ja.md).

## Documentation

| Document | What it covers |
|---|---|
| [docs/ARCHITECTURE.md](https://github.com/97kuek/flow5ctl/blob/main/docs/ARCHITECTURE.md) | Layers, data flow, why one core with two front-ends |
| [docs/ARCHITECTURE-ja.md](https://github.com/97kuek/flow5ctl/blob/main/docs/ARCHITECTURE-ja.md) | 日本語の全体像。アーキテクチャ図つき |
| [docs/ja/QUICKSTART.md](https://github.com/97kuek/flow5ctl/blob/main/docs/ja/QUICKSTART.md) | 日本語のはじめかた。ターミナル未経験者向け |
| [docs/ja/DESIGN-GUIDE.md](https://github.com/97kuek/flow5ctl/blob/main/docs/ja/DESIGN-GUIDE.md) | 日本語の設計ガイド（DESIGN-GUIDE.md の全訳） |
| [docs/DOMAIN-MODEL.md](https://github.com/97kuek/flow5ctl/blob/main/docs/DOMAIN-MODEL.md) | Vocabulary and the `design.yaml` schema |
| [docs/MCP.md](https://github.com/97kuek/flow5ctl/blob/main/docs/MCP.md) | Setting up Claude Desktop, and how to read what comes back |
| [docs/MCP-TOOLS.md](https://github.com/97kuek/flow5ctl/blob/main/docs/MCP-TOOLS.md) | The tool surface exposed to agents |
...
| [examples/](https://github.com/97kuek/flow5ctl/tree/main/examples) | Worked designs: an RC glider, an HPA, and a study |
...
Contributing: [CONTRIBUTING.md](https://github.com/97kuek/flow5ctl/blob/main/CONTRIBUTING.md) · Working with AI agents in this repo: [AGENTS.md](https://github.com/97kuek/flow5ctl/blob/main/AGENTS.md)
...
- **Induced drag depends on the wake length, and flow5's default is too short for a
  ...
  and [the correction is recorded](https://github.com/97kuek/flow5ctl/blob/main/docs/log/2026-09-04-the-wake-was-too-short.md).
- **Flaps and control surfaces are not supported, and cannot be.** flow5 has no flap
  ...
  [the verification log](https://github.com/97kuek/flow5ctl/blob/main/docs/log/2026-09-03-poc-verification.md), findings 9 and 10.
- **macOS only.** Linux and Windows are unverified and not claimed. The package is
  ...
  platform. [`poc/verify_platform.py`](https://github.com/97kuek/flow5ctl/blob/main/poc/verify_platform.py) checks every
...
See [ADR-0006](https://github.com/97kuek/flow5ctl/blob/main/docs/adr/0006-licensing-and-the-gpl-boundary.md).

`flow5ctl` is not affiliated with or endorsed by the flow5 project.

## License

Apache-2.0 (proposed — see [ADR-0006](https://github.com/97kuek/flow5ctl/blob/main/docs/adr/0006-licensing-and-the-gpl-boundary.md)).
